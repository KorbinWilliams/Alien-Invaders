...
namespace ConsoleAdventure.Project.Models
{
  public class Game : IGame
  {
    ...
    public void Setup()
    {
      ...
      Item cellphone = new Item("cellphone", "a Nokia cellphone, the only thing aside from cockroaches that can survive a nuclear blast.");
      Item raygun = new Item("raygun", "gun that goes pew pew");
      ...
      Meridian.Items.Add(raygun);
      Boise.Items.Add(cellphone);

      Alien ET = new Alien("ET", 10);
